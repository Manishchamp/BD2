...
//ENDPOINT 1
function sortedByPricing(pricing) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  let result = sortedByPricing(pricing);
  res.json({ hotels: result });
});
//ENDPOINT 2
function sortedByRatings(rating) {
  let result = hotels.slice();
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  let result = sortedByRatings(rating);
  res.json({ hotels: result });
});
//ENDPOINT 3
function sortedByReviews(reviews) {
  let result = hotels.slice();
  if (reviews === 'least-to-most') {
    result.sort((a, b) => a.reviews - b.reviews);
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  let result = sortedByReviews(reviews);
  res.json({ hotels: result });
});
//ENDPOINT 4
